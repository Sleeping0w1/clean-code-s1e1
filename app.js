...
var incompleteTaskHolder=document.querySelector(".tasks-active");//ul of .tasks-active
var completedTasksHolder=document.querySelector(".tasks-completed");//tasks-completed
...
var createNewTaskElement=function(taskString){
    ...
    //label
    var h4=document.createElement("h4");//h4
    //input (text)
...
var editTask=function(){
    ...
    var editHeading=listItem.querySelector(".task__heading");
    ...
    if(containsClass){
        ...
        editHeading.innerText=editInput.value;
        editBtn.innerText="Edit";
    }else{
        editInput.value=editHeading.innerText;
